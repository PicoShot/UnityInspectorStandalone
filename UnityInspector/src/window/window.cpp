...
namespace Window
{
	static void SetDarkPlusTheme()
	{
		...
		colors[ImGuiCol_CheckboxSelectedBg] = ImVec4(0.20f, 0.22f, 0.23f, 1.00f);
		...
		colors[ImGuiCol_DragDropTargetBg] = ImVec4(0.33f, 0.67f, 0.86f, 0.31f);
		...
		colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(0.26f, 0.59f, 0.98f, 0.50f);
